package com.avo.planning.config;
...
@Configuration
@EnableMongoRepositories("com.avo.planning.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.avo.planning.config.dbmigrations");
